		...
		for (i in obj)
		{
			...
			if(i%item_render == 0 )
			{
				...
				if(i%one_row_item_render == 0 )
				{
					round = round + 1;
					if(round == 1) {
						responce_str += '<div class="row group-'+round+'"><div class="col-md-3"><div class="club-hover"><a tabindex="0" role="button" data-toggle="popover" data-html="true" c_data='+obj[i].id+' close_days="'+obj[i].club_open_days+'"><img src="'+img_ab_path+obj[i].logo+'" class="img-responsive"><span>'+obj[i].name+' </span></a></div></div>';
					}
					else {
						responce_str += '</div><div class="row group-'+round+'"><div class="col-md-3"><div class="club-hover"><a tabindex="0" role="button" data-toggle="popover" data-html="true" c_data='+obj[i].id+' close_days="'+obj[i].club_open_days+'"><img src="'+img_ab_path+obj[i].logo+'" class="img-responsive"><span>'+obj[i].name+' </span></a></div></div>';
				...
				{
					responce_str += '<div class="col-md-3"><div class="club-hover"><a tabindex="0" role="button" data-toggle="popover" data-html="true" c_data='+obj[i].id+' close_days="'+obj[i].club_open_days+'"><img src="'+img_ab_path+obj[i].logo+'" class="img-responsive"><span>'+obj[i].name+' </span></a></div></div>';
				}
